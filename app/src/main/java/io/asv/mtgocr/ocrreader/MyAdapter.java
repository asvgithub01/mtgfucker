...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> implements View.OnClickListener {
    ...
    HashMap<CardInfo, Runnable> pendingRunnables = new HashMap<>(); // map of items to pending runnables, so we can cancel a removal if need be
            ...
            private GestureDetector gesture = new GestureDetector(mContext,
                    new GestureDetector.SimpleOnGestureListener() {
                        ...
                        public boolean onFling(MotionEvent e1,
                            ...
                            TranslateAnimation anim = new TranslateAnimation(e1.getX(), e2.getX(), e1.getY(), e2.getY());
